<div class="container-fluid">
	...
	<%= _.template($('#input_constructor').html())({id:"minScore", description:tr("Minimum rating"), default_selector: "string", disable_int:true, value_string: "0.3", help: {description: tr("Minimum rating which should come from the server response")} }) %>
	<%= _.template($('#input_constructor').html())({id:"pageAction", description:tr("Action name"), default_selector: "string", disable_int:true, value_string: "verify", help: {description: tr("The name of the action to be solved captcha")} }) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Solve Recaptcha V3</div>
</div>

...
var enterpriseAction = GetInputConstructorValue('enterpriseAction', loader);
var isInvisible = GetInputConstructorValue('isInvisible', loader);
var data_s = GetInputConstructorValue('data_s', loader);
var cookies = GetInputConstructorValue('cookies', loader);
...
try {
  var code =
    ...
    _.template($('#CaptchaCustom_RecaptchaV2_code').html())({
      ...
      enterpriseAction: enterpriseAction['updated'],
      isInvisible: isInvisible['updated'],
      data_s: data_s['updated'],
